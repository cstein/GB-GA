...
def mutate(mol: Chem.Mol, mutation_rate: float, molecule_filter: Union[None, List[Chem.Mol]]) -> Union[None, Chem.Mol]:
    ...
    for i in range(10):
        ...
        for m in new_mol_trial:
            m = m[0]
            if co.mol_ok(m, molecule_filter) and co.ring_ok(m):
